...
const TOOLS = [
  ...
  { id: "biblioteca",  name: "Biblioteca de Ofertas",   desc: "Dashboard de ofertas garimpadas: anúncios ativos, dias no ar, ticket, copy e links úteis — em cards com preview completo.", icon: "M4 19.5A2.5 2.5 0 016.5 17H20M4 19.5A2.5 2.5 0 006.5 22H20V2H6.5A2.5 2.5 0 004 4.5v15z", isNew: true },
  { id: "vendas",      name: "Rastreador de Vendas",    desc: "Vendas, lucro, ticket médio e ROAS puxados automaticamente da API do Facebook Ads, por campanha.", icon: "M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6", isNew: true },
  { id: "modelar",     name: "Modelar Oferta",          desc: "Novos ângulos e promessas → página de vendas editável: paletas de cor, várias fontes, preview no celular, seções que você adiciona/remove e botões com link de checkout. Publica no Netlify.", icon: "M12 3l1.9 5.8L20 10l-6.1 1.2L12 17l-1.9-5.8L4 10l6.1-1.2L12 3zM19 15l.9 2.6L22 18l-2.1.4L19 21l-.9-2.6L16 18l2.1-.4L19 15z", isNew: true },
  { id: "ocr",         name: "Imagem → Texto",          desc: "OCR em português no navegador: extraia o texto de prints e criativos e copie só os trechos que quiser.", icon: "M4 7V4h3M20 7V4h-3M4 17v3h3M20 17v3h-3M7 9h10M7 13h6M7 17h8", isNew: true },
  { id: "lowticket",   name: "Modelador Low Ticket",    desc: "Oferta, copy, funil, campanha e checklist prontos pra lançar um low ticket em minutos.", icon: "M12 2a10 10 0 100 20 10 10 0 000-20zM12 6v6l4 2" },
  ...
  { id: "audio",       name: "Gerador de Áudio",        desc: "Transforme copies em narração com as vozes neurais/naturais em português — as mais realistas do navegador.", icon: "M11 5L6 9H2v6h4l5 4V5zM15.5 8.5a5 5 0 010 7M19 5a9 9 0 010 14", isNew: true },
  ...
  { id: "criativo",    name: "Estúdio de Criativos",    desc: "Milhares de combinações (22 temas × 9 layouts × padrões) + vídeos animados + geração por IA (Gemini/ChatGPT/Copilot) com prompt automático da sua oferta.", icon: "M4 16l4.6-4.6a2 2 0 012.8 0L16 16m-2-2l1.6-1.6a2 2 0 012.8 0L20 14M4 4h16v16H4zM14 8h.01", isNew: true },

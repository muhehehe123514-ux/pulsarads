...
const TOOLS = [
  ...
  { id: "modelar",     name: "Modelar Oferta",          desc: "Novos ângulos pra novos públicos → promessa → headline → página de vendas pronta, editável e publicável no Netlify.", icon: "M12 3l1.9 5.8L20 10l-6.1 1.2L12 17l-1.9-5.8L4 10l6.1-1.2L12 3zM19 15l.9 2.6L22 18l-2.1.4L19 21l-.9-2.6L16 18l2.1-.4L19 15z", isNew: true },
  ...
  { id: "criativo",    name: "Estúdio de Criativos",    desc: "Centenas de combinações de modelos (12 temas × 6 layouts × padrões) + vídeos animados em WebM. Grátis.", icon: "M4 16l4.6-4.6a2 2 0 012.8 0L16 16m-2-2l1.6-1.6a2 2 0 012.8 0L20 14M4 4h16v16H4zM14 8h.01", isNew: true },
